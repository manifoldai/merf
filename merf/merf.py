...
class MERF(object):
    def __init__(self, min_iterations=10, gll_early_stop_threshold=1e-4, max_iterations=20, rf_params=None):
        self.min_iterations = min_iterations
        self.gll_early_stop_threshold = gll_early_stop_threshold
        self.max_iterations = max_iterations
        self.rf_params = {'n_estimators': 300} if rf_params is None else rf_params
